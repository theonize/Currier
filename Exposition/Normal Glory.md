...
Examples of common extra-Biblical pursuits are real-estate, lack of orthodoxy (such as corporate prayer and Biblical exegesis), and lack of orthopraxy (fellowship and meals).
...
It is a circular rut that the Institution implements vicarious ministries which are only operable by a clergy.
...
The hope in this research is to explore the issues involved in a mass believers' defection from the institutional Church.
